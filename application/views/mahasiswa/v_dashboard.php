                    ...
                    <div class="card-body border-start border-4 border-danger rounded start">
                        <div class="row">
                            ...
                            <div class="col-9 text-start">
                                ...
                                <span class="d-block fw-bolder" style="font-size: 1.25rem;"><?= $jml_absensi['jumlah_hadir']; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card w-100">
                    <div class="card-body border-start border-4 border-primary rounded start">
                        <div class="row">
                            <div class="col-3 d-flex justify-content-center align-items-center">
                                <span>
                                    <!-- <iconify-icon icon="eos-icons:bubble-loading" width="2.65rem" style="color: #d9d9d9;"></iconify-icon> -->
                                    <iconify-icon icon="uiw:loading" width="2.65rem" style="color: #d9d9d9;"></iconify-icon>
                                </span>
                            </div>
                            <div class="col-9 text-start">
                                <span class="fw-bolder text-uppercase d-inline-block mb-2" style="font-size: 0.595rem;">Progres Bimbingan</span>
                                <div class="progress" role="progressbar" aria-label="Basic example" aria-valuenow="<?= $jml_absensi['jumlah_hadir']; ?>" aria-valuemin="0" aria-valuemax="8">
                                    <?php
                                    // Hitung persentase lebar progress bar
                                    $jumlah_hadir = $jml_absensi['jumlah_hadir'];
                                    $max_absensi = 8; // Nilai maks absensi
                                    $width_percentage = ($jumlah_hadir / $max_absensi) * 100;
                                    ?>
                                    <div class="progress-bar" style="width: <?= $width_percentage; ?>%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card w-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-9">
                            ...
                            <div class="mb-3 mb-sm-0">
                                <a href="<?= base_url('mahasiswa/print_kalender') ?>" class="btn btn-primary d-flex">
