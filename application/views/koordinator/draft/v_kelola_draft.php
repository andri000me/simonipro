              ...
              <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                  <div class="mb-3 mb-sm-0">
                    <h5 class="card-title fw-semibold">Daftar Pengumpulan Draft Sidang</h5>
                  </div>
                </div>
              <div class="card">
                <div class="card-body">
                        ...
                        <tr>
                          ...
                          <td>
                            <h6 class="fw-semibold mb-1">
                                <?= $draft['dosen_pembimbing_nama']; ?>
                            </h6>
                            <span class="fw-normal">
                                <?= $draft['dosen_pembimbing_nidn']; ?>
                            </span>
                          </td>
                          <td>
                            <h6 class="fw-semibold mb-1">
                                <?= $draft['mahasiswa_nama']; ?>
                            </h6>
                            <span class="fw-normal">
                                <?= $draft['mahasiswa_npm']; ?>
                            </span>
                          ...
                          <td>
                            <small>
                            <a href="detail_draft/<?= $draft['id']; ?>" class="btn btn-outline-primary mb-2">
                                <span>
