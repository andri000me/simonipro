...
CREATE TABLE `absensi_bimbingan` (
  ...
  `status` enum('belum dikonfirmasi','hadir','rekomendasi') NOT NULL DEFAULT 'belum dikonfirmasi',
...
INSERT INTO `absensi_bimbingan` (`id`, `kelompok_id`, `mahasiswa_id`, `tgl_bimbingan`, `topik`, `status`, `is_confirmed`, `catatan_penolakan`, `created_at`, `updated_at`) VALUES
(4, 5, 22, '2024-07-16', 'Indonesia Emas 2345: Kebodohan KOMINFO.', 'belum dikonfirmasi', 'pending', NULL, 1720971389, 1720971389);
