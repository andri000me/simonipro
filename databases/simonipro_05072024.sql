...
(6, '0427128203', 'Jonathan Doe S.H.,MTK.', 36, '6686153c948da.png');
...
--
-- Dumping data for table `plotting_pembimbing`
--

INSERT INTO `plotting_pembimbing` (`id`, `koordinator_id`, `dosen_pembimbing_id`, `mahasiswa_id`, `created_at`, `updated_at`) VALUES
(1, 2, 6, 18, 1720018906, 1720083025),
(2, 2, 6, 19, 1720063325, 1720063325);
...
(36, '0427128203', '$2y$10$2j1R8yxc55txt1YjCs3xu.dziUQv/lTdHPSlDRTveB1DZkwpwBY6u', 3, 1, 1720063231, 1720063231),
(37, 'meysha@kaprodi', '$2y$10$rFc.6RE6P6nWk2OTjdPpOO7PZzkuPCC7AsZ8RLWCsxfvAXi/F/HBC', 5, 1, 1720159023, 1720159023);
