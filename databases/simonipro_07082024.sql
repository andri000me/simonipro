...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2024 at 12:35 AM
...
(31, 6, 23, '2024-07-20', '10:50:00', 'Pembahasan judul laporan', 'hadir', 'confirmed', 1, NULL, 1721415095, 1722796531),
(32, 6, 26, '2024-07-20', '13:15:00', 'Pengajuan judul laporan proyek 2', 'rekomendasi', 'confirmed', 1, NULL, 1721415303, 1722131718),
(33, 6, 26, '2024-07-21', '11:00:00', 'Hello World!', 'rekomendasi', 'confirmed', 1, NULL, 1721581077, 1722796480),
(34, 6, 26, '2024-07-23', '06:03:00', 'asdasdasd', 'rekomendasi', 'confirmed', 1, NULL, 1721581399, 1722796541),
...
(45, 6, 26, '2024-08-05', '06:40:00', 'Lorem ipsum', 'rekomendasi', 'confirmed', 1, NULL, 1722796603, 1722796726),
(46, 6, 26, '2024-08-06', '07:40:00', 'Hello world!', 'rekomendasi', 'confirmed', 1, NULL, 1722796628, 1722796734),
(47, 6, 26, '2024-08-08', '13:40:00', 'Hello world!', 'rekomendasi', 'confirmed', 1, NULL, 1722796666, 1722796743),
(48, 6, 26, '2024-08-29', '13:40:00', 'Chuakkkzzzssss', 'rekomendasi', 'confirmed', 1, NULL, 1722796703, 1722796751),
(49, 6, 26, '2024-08-30', '14:40:00', 'asteroid raksasa', 'rekomendasi', 'confirmed', 1, NULL, 1722796799, 1722796823);
...
(25, 26, 'SISTEM INFORMASI MONITORING BIMBINGAN PROYEK 2 (SIMONIPRO) BERBASIS WEB DENGAN METODE PROTOTYPE', 6, '66afcda4df32b.pdf', '66afcda4df32b1.pdf', 1, 'approved', NULL, 1722797476);
...
INSERT INTO `jadwal` (`id`, `tahun_akademik`, `nama_jadwal`, `created_at`, `updated_at`, `status`) VALUES
(3, '2024-2025', 'Proyek 2', 1719714822, 1720344730, 'published'),
(10, '2025-2026', 'Proyek 2', 1722931552, 1722931552, 'draft');
...
(4, 1, 11, 202, 'Gandaria', '2024-08-05', '08:00:00', 1722559431, NULL),
(6, 1, 12, 202, 'Gandaria', '2024-08-05', '09:00:00', 1722560269, 1722563344),
(7, 1, 17, 105, 'Cukurukuk', '2024-08-05', '08:00:00', 1722798243, NULL);
...
(27, 54, '623220012', 'Devina', 1, 2, 4, '2022', 'default.jpeg', 3.15);
...
CREATE TABLE `penilaian` (
  `id` int(11) NOT NULL,
  `plotting_id` int(11) NOT NULL,
  `nilai_pembimbing` float(5,2) NOT NULL,
  `nilai_penguji_1` float(5,2) NOT NULL,
  `nilai_penguji_2` float(5,2) NOT NULL,
  `grade` char(2) DEFAULT NULL,
  `status_kelulusan` varchar(30) DEFAULT NULL,
  `created_at` int(11) DEFAULT NULL,
  `updated_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `penilaian` (`id`, `plotting_id`, `nilai_pembimbing`, `nilai_penguji_1`, `nilai_penguji_2`, `grade`, `status_kelulusan`, `created_at`, `updated_at`) VALUES
(5, 11, 75.20, 84.90, 90.00, 'AB', 'Lulus Dengan Perbaikan', 1722661118, 1722743604),
(9, 12, 89.20, 80.95, 90.00, 'A', 'Lulus Tanpa Perbaikan', 1722743690, 1722743690),
(10, 17, 90.00, 89.25, 88.70, 'A', 'Lulus Tanpa Perbaikan', 1722798188, 1722798188);
...
(17, 4, 6, 9, 10, 26, 1, 2, 1720890245, 1722798105),
(18, 4, 6, NULL, NULL, 27, 1, 1, 1722453665, 1722453665);
...
(49, '623220004', '$2y$10$gXMWG8Kkma5.65gtDdGhqej7WNMWcNBDnZohUOQrQDfoxeWtB584i', 4, 'Asep Supriyadi', '', 1, 1720355091, 1722675323),
...
(54, '623220012', '$2y$10$q21Sypvf2dsr3Og2FgywM./BxZzP91E0bgNlgOGmuswvlfy3KDqji', 4, 'Devina', '081767686677', 1, 1722453314, 1722453314);
